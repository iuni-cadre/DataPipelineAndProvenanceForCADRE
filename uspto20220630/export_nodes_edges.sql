...
SELECT location_id,
        REGEXP_REPLACE(disambig_city,'"','','g') AS disambig_city,
        county,
        disambig_state,
        disambig_country,
        state_fips,
...
SELECT patent_id,
        ...
        REGEXP_REPLACE(REGEXP_REPLACE(REGEXP_REPLACE(patent_abstract,'\t',' t','g'),'\n','','g'),'"','','g') AS patent_abstract,
        REGEXP_REPLACE(REGEXP_REPLACE(REGEXP_REPLACE(patent_title,'\t',' t','g'),'\n','','g'),'"','','g') AS patent_title,
        wipo_kind,
        num_claims
