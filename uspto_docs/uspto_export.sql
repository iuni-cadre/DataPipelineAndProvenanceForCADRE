...
SELECT  patent_id,
		...
		detail_desc_length
FROM patent
INTO OUTFILE '/tmp/csv_for_janusgraph/nodes/patent.tsv'
FIELDS ENCLOSED BY '"' 
TERMINATED BY '\t' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';
...
UNION
SELECT DISTINCT(mainclass_id) AS 'uspc_id', 'mainclass' AS 'level', mainclass_title AS 'label' FROM uspc_current
UNION ALL
SELECT DISTINCT(subclass_id) AS 'uspc_id', 'subclass' AS 'level', subclass_id AS 'label' FROM uspc_current
INTO OUTFILE '/tmp/csv_for_janusgraph/categories/uspc_node.tsv'
FIELDS ENCLOSED BY '"' 
TERMINATED BY '\t' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';
...
UNION ALL 
SELECT patent_id, subclass_id AS 'uspc_id' FROM uspc_current
INTO OUTFILE '/tmp/csv_for_janusgraph/categories/uspc_to_patent.tsv'
FIELDS ENCLOSED BY '"' 
TERMINATED BY '\t' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';
